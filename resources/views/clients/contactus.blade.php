                ...
                <div class="col-md-6 pr-0">
                    <form  action="{{ route('contact.send') }}" method="POST">
                        ...
                        <div class="form-group position-relative">
                            ...
                            <input type="text" id="formSubject" class="form-control form-control-lg thick"
                        ...
                        <div class="form-group message">
                            <textarea id="formMessage" class="form-control form-control-lg" rows="7" placeholder="Mensagem" name="message"></textarea>
                        </div>
