...
<div class="container">
    ...
    <div class="row text-center space-between mt-4">
        <div class="col-md-6">
            <a href="{{ route('lespacks') }}" class="btn btn-secondary btn-lg"><i class="fa fa-arrow-left"></i> Back to Packs</a>

        </div>
        <div class="col-md-6">
            <a type="button" class="btn btn-danger btn-lg text-light add-to-cart" data-product-id="{{ $pack->id }}"  data-is-pack="true">add pack to pannier <i class="fa fa-shopping-bag"></i> </a>
